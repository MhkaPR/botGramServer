...
updateMessagePacket::updateMessagePacket(TextMessage message) /*Client_Mssages(MessageStruct)*/{
...
//    query_getRoomsData.prepare("SELECT * FROM "+MessageStruct.getSender());
...
//        getupdates(lastUpdate,MessageStruct);
